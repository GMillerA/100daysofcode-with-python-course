# -*- coding: utf-8 -*-
"""
Groceries class from:
    https://github.com/pybites/blog_code/blob/master/pytest/fixtures/groceries.py
Python script for documenting groceries
"""
...
Item = namedtuple('Item', 'product price craving number recipe')
#Items in Groceries include the product name, price, if it's a craving,
    #the number of items needed, and correlated recipe (if any)
...
# =============================================================================
        if any(item for item in self if item.product == new_item.product):
            new_item.number = new_item.number + 1
